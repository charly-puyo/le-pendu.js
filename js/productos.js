...
const productosHombres = [
    ...
    new Producto("5", "../assets/5.jpg", "Zapatillas", "High-Top", 130500, 1),
    ...
    new Producto("126", "../assets/126.jpg", "Remera", "Mc Digi", 18440, 1),
    ...
    new Producto("140", "../assets/140.jpg", "Pantalon", "Skate Bor", 45000, 0),
...
const productosMujeres = [
    ...
    new Producto("11", "../assets/11.jpg", "Zapatillas", "Crisis DC", 146600, 1),
    new Producto("12", "../assets/12.jpg", "Zapatillas", "Midway DC", 145600, 2),
    new Producto("13", "../assets/13.jpg", "Zapatillas", "Midway DC", 145600 ),
    ...
    new Producto("133", "../assets/133.jpg", "Remera", "Mc The Weekend", 18546, 1),
    ...
    new Producto("138", "../assets/138.jpg", "Remera", "ML Always", 19500, 1),
